...
export const asyncRouterMap = [{
    ...
    children: [
      ...
      // archives new2023 problem: permission 因为你这个账户没这个权限 你没给加
      {
        path: '/archives',
        name: 'archives',
        redirect: '/archives/family',
        component: RouteView,
        meta: {
          title: 'menu.archives',
          icon: 'table'
        ...
        children: [{
          ...
          name: 'family',
          component: () => import('@/views/archives/Family'),
          meta: {
            title: 'menu.archives.family',
            keepAlive: true
          }
        }]
      },

      // notice new2023 problem: permission 因为你这个账户没这个权限 你没给加
      {
        path: '/notice',
        name: 'notice',
      ...
      // people new2023 problem: permission 因为你这个账户没这个权限 你没给加
      {
        path: '/people',
        name: 'people',
      ...
      // settings new2023 problem: permission 因为你这个账户没这个权限 你没给加
      {
        path: '/settings',
        name: 'settings',
      ...
      // vip new2023 problem: permission 因为你这个账户没这个权限 你没给加
      {
        path: '/vip',
        name: 'vip',
        redirect: '/vip/list',
