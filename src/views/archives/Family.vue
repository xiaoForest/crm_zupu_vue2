    ...
    <a-card :bordered="false" class="ant-pro-components-tag-select">
      <a-form :form="form" layout="inline">
        <standard-form-row title="所属类目" block style="padding-bottom: 11px;">
          <a-form-item>
            <tag-select>
              <tag-select-option value="Category1">传记</tag-select-option>
              <tag-select-option value="Category2">祖训族规</tag-select-option>
              <tag-select-option value="Category3">谱例</tag-select-option>
              <tag-select-option value="Category4">坟茔</tag-select-option>
            </tag-select>
          </a-form-item>
        </standard-form-row>

        <standard-form-row title="创建人" grid last>
          <a-row>
            <a-col :md="24">
